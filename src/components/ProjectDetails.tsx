              ...
              <div className="space-y-4">
                <div className="flex flex-wrap items-center gap-3">
                  <span className={cn(
                    ...
                    isOpen ? "bg-emerald-50 text-emerald-600 border-emerald-100" :
                      isAssigned ? "bg-amber-50 text-amber-600 border-amber-100" :
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-3xl font-black text-slate-900">
                    {typeof project.budget === 'number'
                      ? `${project.budget.toLocaleString()} ALGO`
                      : project.budget}
                  </span>
                </div>
              </div>
          ...
          <motion.section variants={itemVariants} className="rounded-[2.5rem] bg-white border border-slate-100 p-8 md:p-10 shadow-xl shadow-slate-100/50 space-y-6">
            ...
            <div className="pt-6 space-y-4">
              ...
              <div className="rounded-2xl bg-indigo-50/30 border border-indigo-50 p-6">
                <p className="text-base font-bold text-slate-700 italic">"{project.expectedOutcome ?? project.outcome}"</p>
              </div>
            </div>
          </motion.section>
                    ...
                    <div className="relative z-10 flex flex-col md:flex-row md:items-start justify-between gap-4">
                      <div className="space-y-2">
                        <div className="flex items-center gap-3">
                          ...
                          {m.percentage && (
                            <span className="inline-flex items-center px-3 py-1 rounded-full bg-amber-50 text-amber-600 border border-amber-100 text-[9px] font-black uppercase tracking-widest">
